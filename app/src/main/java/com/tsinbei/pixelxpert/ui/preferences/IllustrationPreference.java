 ...
 * Credit: <a href="https://github.com/DHD2280/Oxygen-Customizer/blob/beta/app/src/main/java/it/dhd/oxygencustomizer/ui/preferences/IllustrationPreference.java">...</a>
 */
public class IllustrationPreference extends Preference {
	...
	public void onBindViewHolder(@NonNull PreferenceViewHolder holder) {
		...
		final ImageView backgroundView = (ImageView) holder.findViewById(R.id.background_view);
		final FrameLayout middleGroundLayout = (FrameLayout) holder.findViewById(R.id.middleground_layout);
		final LottieAnimationView illustrationView = (LottieAnimationView) holder.findViewById(R.id.lottie_view);
		...
		final FrameLayout illustrationFrame = (FrameLayout) holder.findViewById(R.id.illustration_frame);
		final LayoutParams lp = illustrationFrame.getLayoutParams();
