...
public class MLKitSegmentor {
	...
	public static Bitmap extractSubject(Context context, Bitmap input)
	{
		try
		{
			...
			new MLKitSegmentor(context).segmentSubject(input, new MLKitSegmentor.SegmentResultListener() {
				@Override
	...
	public MLKitSegmentor(Context context)
	{
		mContext = context;
